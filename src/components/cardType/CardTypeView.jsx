      ...
      <main className="flex-1 p-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-stone-500">Manage and view card type list</p>
          </div>
        ...
        <div className="rounded-2xl border border-stone-200 bg-white shadow-sm">
          ...
          <div className="border-b border-stone-200 px-6 py-4">
            <h2 className="text-base font-semibold text-stone-800">Card Type List</h2>
          </div>
                  ...
                  <tr>
                    ...
                    >
                      <div className="flex flex-col items-center gap-2 text-stone-400">
                        ...
                        {searchQuery ? `No card types match "${searchQuery}"` : 'No card types found.'}
                      </div>
                    </td>
                  </tr>
                )}
          ...
          <div className="flex items-center justify-between border-t border-stone-100 px-6 py-4">
            <p className="text-sm text-stone-500">
              ...
              <span className="font-semibold text-stone-800">{items.length}</span> card types
            </p>
            <div className="flex items-center gap-2">
              <button
                type="button"
          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl border border-stone-200">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-stone-900">
                {editingId ? 'Edit Card Type' : 'Add Card Type'}
              </h2>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              {/* Card Type Name */}
              <div>
                <label htmlFor="card_types" className="mb-1.5 block text-sm font-medium text-stone-700">
                  Card Type Name
                </label>
                <input
                  id="card_types"
                  ...
                  onChange={onChange}
                  placeholder="Enter card type name (e.g. Muslim)"
                  required
              ...
              {/* Status */}
              <div>
                <label htmlFor="card_types_status" className="mb-1.5 block text-sm font-medium text-stone-700">
                  Status
                </label>
                <select
